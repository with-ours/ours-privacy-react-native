...
class JSONHandler {
    ...
    class func encodeAPIData(_ obj: MPObjectToParse) -> String? {
        ...
        guard let d = data else {
            OursPrivacyLogger.warn(message: "couldn't serialize object")
            return nil
        }
    ...
    class func deserializeData(_ data: Data) -> MPObjectToParse? {
        ...
        do {
            ...
            OursPrivacyLogger.warn(message: "exception decoding object data")
        }
        return object
    }
    ...
    class func serializeJSONObject(_ obj: MPObjectToParse) -> Data? {
        ...
        do {
            ...
            OursPrivacyLogger.warn(message: "exception encoding api data")
        }
    ...
    private class func makeObjectSerializable(_ obj: MPObjectToParse) -> MPObjectToParse {
        ...
        default:
            ...
            if objString == "nil" {
                ...
                OursPrivacyLogger.info(message: "enforcing string on object")
                return objString
            }
        }
    }
