...
public class TestUtils {
    ...
    public static class CleanOursPrivacyAPI extends OursPrivacyAPI {
        public CleanOursPrivacyAPI(final Context context, final Future<SharedPreferences> referrerPreferences, final String token, final boolean trackAutomaticEvents) {
            super(context, referrerPreferences, token, false, null, trackAutomaticEvents);
        }

        public CleanOursPrivacyAPI(final Context context, final Future<SharedPreferences> referrerPreferences, final String token) {
            super(context, referrerPreferences, token, false, null, false);
        }

        public CleanOursPrivacyAPI(final Context context, final Future<SharedPreferences> referrerPreferences, final String token, final String instanceName) {
    ...
    public static class EmptyPreferences implements Future<SharedPreferences> {
        public EmptyPreferences(Context context) {
            mPrefs = context.getSharedPreferences("OURSPRIVACY_TEST_PREFERENCES", Context.MODE_PRIVATE);
