...
public class HttpTest {
    ...
    private OursPrivacyAPI mMetrics;
    ...
    public void setUp() {
        ...
        final OPConfig config = new OPConfig(new Bundle(), InstrumentationRegistry.getInstrumentation().getContext(), null) {
        ...
        final OPDbAdapter mockAdapter = new OPDbAdapter(InstrumentationRegistry.getInstrumentation().getContext(), config) {
            @Override
        ...
        mMetrics = new TestUtils.CleanOursPrivacyAPI(InstrumentationRegistry.getInstrumentation().getContext(), mMockPreferences, "Test Message Queuing") {
            @Override
