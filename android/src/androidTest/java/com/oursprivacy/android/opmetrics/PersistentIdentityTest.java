...
public class PersistentIdentityTest {
    ...
    public void setUp() {
        ...
        Future<SharedPreferences> oursprivacyLoader = loader.loadPreferences(InstrumentationRegistry.getInstrumentation().getContext(), TEST_OURSPRIVACY_PREFERENCES, null);

        mPersistentIdentity = new PersistentIdentity(referrerLoader, testLoader, timeEventsLoader, oursprivacyLoader);
    }
    ...
    private static final String TEST_OURSPRIVACY_PREFERENCES  = "TEST OURSPRIVACYPREFS";
}
