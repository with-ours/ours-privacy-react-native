...
/* package */ class SystemInformation {
    ...
    private SystemInformation(Context context) {
        ...
        try {
            ...
            OPLog.w(LOGTAG, "System information constructed with a context that apparently doesn't exist.");
        }
        ...
        if (null != hasSystemFeatureMethod) {
            try {
                ...
                OPLog.w(LOGTAG, "System version appeared to support PackageManager.hasSystemFeature, but we were unable to call it.");
    ...
    private static final String LOGTAG = "OursPrivacyAPI.SysInfo";
}
