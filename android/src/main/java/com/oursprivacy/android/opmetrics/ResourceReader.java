...
/**
 * This class is for internal use in the OursPrivacy library, and should not be imported into
 * client code.
 */
public abstract class ResourceReader implements ResourceIds {
                ...
                if (Modifier.isStatic(modifiers)) {
                    ...
                    if (fieldType == int.class) {
                        try {
                            ...
                            // https://github.com/oursprivacy/oursprivacy-android/issues/241
                            OPLog.e(LOGTAG, "Can't read built-in id name from " + platformIdClass.getName(), e);
                        }
                    }
                }
            }
        } catch (IllegalAccessException e) {
            OPLog.e(LOGTAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            OPLog.w(LOGTAG, "Can't load names for Android view ids from '" + localClassName + "', ids by name will not be available in the events editor.");
            OPLog.i(LOGTAG,
    ...
    private static final String LOGTAG = "OursPrivacyAPI.RsrcReader";
}
