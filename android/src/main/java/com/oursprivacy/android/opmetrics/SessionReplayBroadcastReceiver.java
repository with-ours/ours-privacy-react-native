...
import com.oursprivacy.android.util.OPConstants.SessionReplay;
...
public class SessionReplayBroadcastReceiver extends BroadcastReceiver {
    ...
    private final OursPrivacyAPI sdkInstance;
    ...
    public SessionReplayBroadcastReceiver(OursPrivacyAPI instance) {
        ...
        if (SessionReplay.REGISTER_ACTION.equals(action)) {
            ...
            if (serializableData instanceof HashMap) {
                try {
                    ...
                    OPLog.e(LOGTAG, "Failed to cast broadcast extras data to HashMap", e);
