...
/**
 * A utility class for handling migration from legacy versions, internal use only in the OursPrivacy library. Not thread-safe.
 */
public class LegacyVersionUtils {
    ...
    private static final String DEFAULT_DIRECTORY_PREFIX = "OursPrivacyAPI.Images.";
}
