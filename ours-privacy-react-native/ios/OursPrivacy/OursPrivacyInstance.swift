...
@objc open class OursPrivacyInstance: CustomDebugStringConvertible, FlushDelegate, AEDelegate {
...
extension OursPrivacyInstance {
     ...
     */
    public func identify(distinctId: String, userProperties: [String: Any]?, completion: (() -> Void)? = nil) {
        if hasOptedOutTracking() {
